...
class CutOffV2:
    ...
    def from_command(cls, data: dict):
        return cls(
            msg = data['cut_off_message_list'][0]['content'],
        )
...
@dataclasses.dataclass
class WATCHED_CHANGE:
    msg: str = ""

    @classmethod
    def from_command(cls, data: dict):
        return cls(
            msg = data['data']['text_large'],
        )

@dataclasses.dataclass
class LIKE_INFO_V3_CLICK:
    msg: str = ""

    @classmethod
    def from_command(cls, data: dict):
        return cls(
            msg = f"#{data['data']['uname']} {data['data']['like_text']}",
        )

@dataclasses.dataclass
class LIKE_INFO_V3_UPDATE:
    msg: str = ""

    @classmethod
    def from_command(cls, data: dict):
        return cls(
            msg = data['data']['click_count'],
        )
